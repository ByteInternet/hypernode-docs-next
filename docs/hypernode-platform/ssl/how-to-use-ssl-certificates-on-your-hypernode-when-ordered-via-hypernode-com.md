...
2. Click the orange**Add SSL** button on the right hand side.
3. Click **+Add managed SSL** **certificate**.
4. Fill in your domain name.
5. Choose the type of SSL certificate.
6. Select a Hypernode on which you want to install the certificate.
7. Select an email address to receive the validation link and check your legal details. The required details may vary, depending on the type of SSL certificate.
...
1. In the Hypernode Control Panel, select SSL from the menu on the left.
2. Select the SSL certificate you want to cancel by clicking **Details**.
3. Click **Don't renew this certificate**and follow the steps.
...
3. To add a new SSL certificate, click the **Add SSL**button on the right.
...
7. Click **Details**and then **(Un)link to Hypernodes**to select one or more Hypernodes to link the certificate to.
...
3. Hover over **Hypernodes**in the sidebar and click **SSL:**
**![](_res/uEon-9GZzywfE7GSNAiSzd45sCWVecpBsw.png)**
4. To add a new SSL certificate, click the **Add SSL**button on the right.
...
3. Hover over **Hypernodes**in the sidebar and click **SSL:**
**![](_res/uEon-9GZzywfE7GSNAiSzd45sCWVecpBsw.png)**
4. Here you'll see an overview of the available SSL certificates. Click **Details**and then **(Un)link to Hypernodes**to link one or more Hypernodes to link the certificate to.
...
5. Click **Details**to go the detail page. You can unlink the domain or delete the SSL certificate from here.
