...
When you’re done developing you can convert to a regular production node at the click of a button in the Control Panel (my.hypernode.com).

### Upgrading Your Development Plan
