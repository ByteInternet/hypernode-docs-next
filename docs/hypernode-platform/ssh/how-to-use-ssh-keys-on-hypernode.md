...
After you have created a key pair, make sure you add your public key to your Hypernode. Please check first if you have access to the Hypernode Control Panel.
...
To finally connect to Hypernode you’ll have to use your SSH hostname and username. You will find this information in the email they received in which we inform you your Hypernode is ready for use.
